...
description: Use this skill whenever the agent needs to read, cite, or reason about DWD RADOLAN radar composites, EUMETSAT MTG satellite products, or their combination as weather-context evidence for a community-submitted photo. Triggers include translating raw radar reflectivity into a storm-attribute reading for a view-cone, picking the right MTG FCI channel for a cloud-top or convective diagnosis, checking whether a photographed phenomenon is consistent with the radar/satellite signal at that timestamp, or naming uncertainty bounds on either instrument. Provides RADOLAN reflectivity interpretation, storm-attribute derivation, the MTG FCI user-facing channel shortlist (0.6, 3.8, 6.3, 7.3, 10.5 plus selected RGB composites), MTG LI product framing, and per-instrument uncertainty framing. Do NOT use for on-the-ground phenomenon identification — that lives in the severe-weather-reporting skill.
